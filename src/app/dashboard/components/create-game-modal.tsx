...
import { ResponsiveModal, ResponsiveModalContent, ResponsiveModalFooter, ResponsiveModalHeader, ResponsiveModalTitle, ResponsiveModalTrigger, ResponsiveModalDescription, ResponsiveModalClose } from "@/components/ui/responsive-model";
        ...
        <ResponsiveModal open={open} onOpenChange={setOpen}>
            ...
            <ResponsiveModalContent className="bg-gradient-to-br from-gray-900 to-black text-white">
                <ResponsiveModalHeader>
                    <ResponsiveModalTitle className="text-2xl font-bold">Create a new game</ResponsiveModalTitle>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div className="space-y-4">
                        ...
                        <div>
                            <h2 className="text-lg font-semibold text-gray-300">Select Bet Amount</h2>
